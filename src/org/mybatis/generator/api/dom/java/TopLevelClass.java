...
public class TopLevelClass extends InnerClass implements CompilationUnit {
	...
	public String getFormattedContent() {
		...
		String getsetAnnotationStr = PropertiesUtils.getInstance().getConfigValue("getset.annotation");
		...
		boolean getsetAnnotation = "true".equalsIgnoreCase(getsetAnnotationStr) ? true : false;
		if (jpaFlag) {
