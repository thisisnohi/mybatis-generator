...
public class Interface extends JavaElement implements CompilationUnit {
    ...
    public String getFormattedContent() {
        ...
        String imp = PropertiesUtils.getInstance().getConfigValue("Interface.import");
        String anno = PropertiesUtils.getInstance().getConfigValue("Interface.annotation");

        if (null != imp && !"".equals(imp)) {
        	sb.append(imp);
            newLine(sb);
        }
